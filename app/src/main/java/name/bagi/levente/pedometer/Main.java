        ...
        mDrawerList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                switch (position) {
                    case 0:
                    case 1:
                        Intent intentProfilim = new Intent(Main.this, MyProfile.class);
                        startActivity(intentProfilim);
                        break;
                    case 2:
                        Intent intentReport = new Intent(Main.this, StepReport2.class);
                    ...
                    case 4:
                        Intent hakkimizdaIntent = new Intent(Main.this, Options.class);
